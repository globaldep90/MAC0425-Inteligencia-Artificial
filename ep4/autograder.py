...
def readCommand(argv):
    ...
    parser.set_defaults(generateSolutions=False, muteOutput=False, printTestCase=False, noGraphics=False)
...
def evaluate(generateSolutions, testRoot, moduleDict, exceptionMap=ERROR_HINT_MAP, muteOutput=False,
    ...
    grades = grading.Grades(projectParams.PROJECT_NAME, questions, muteOutput=muteOutput)
    if questionToGrade == None:
...
if __name__ == '__main__':
    ...
    if options.runTest != None:
        ...
        evaluate(options.generateSolutions, options.testRoot, moduleDict,
            muteOutput=options.muteOutput, printTestCase=options.printTestCase,
